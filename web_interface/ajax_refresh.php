...
define ('DBUSER', 'root');
define ('DBPASS', '');
define ('DBNAME', 'autocomplete');

function connect() {
    return new PDO('mysql:host=localhost;dbname=autocomplete;port=8889', 'root', 'root', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
}
